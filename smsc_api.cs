...
public class SMSC
{
	...
	const string SMSC_LOGIN = "idbonuskz";		    // логин клиента
	const string SMSC_PASSWORD = "239297e625bd8ceff566338c3bee93fc";	// пароль или MD5-хеш пароля в нижнем регистре
